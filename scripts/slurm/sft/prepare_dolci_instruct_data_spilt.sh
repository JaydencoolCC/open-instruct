...
PROJECT_ROOT="$(pwd)"
OUTPUT_DIR="$PROJECT_ROOT/data/sft/dolci_instruct_sft_tokenized_split/"
SPLIT_OUTPUT_DIR="/data01/users/zhanghx/data/Dolci-Instruct-SFT"
...
python scripts/data/convert_sft_data_for_olmocore_spilit.py \
  --tokenizer_name_or_path "$TOKENIZER" \
  --dataset_mixer_list allenai/Dolci-Instruct-SFT 0.99 \
